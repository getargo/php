{{ use Argo\Sapi\Http\Action\Config\GetConfig }}
{{ use Argo\Sapi\Http\Action\Get }}
{{ use Argo\Sapi\Http\Action\Import\GetImport }}
{{ use Argo\Sapi\Http\Action\Tags\GetTags }}
{{ use Argo\Sapi\Http\Action\Pages\GetPages }}
{{ use Argo\Sapi\Http\Action\Posts\GetPosts }}
{{ use Argo\Sapi\Http\Action\Sites\GetSites }}
<!DOCTYPE html>
<html lang="en">
<head>
  {{= meta (['charset' => 'utf-8']) }}
